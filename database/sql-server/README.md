# EnlaceExpress - SQL Server

## Descripción

Esta carpeta contiene los archivos correspondientes a la implementación de la base de datos **EnlaceExpress** en Microsoft SQL Server.

EnlaceExpress es un sistema orientado a la gestión de envíos y servicios de mensajería empresarial.

## Archivos

* `enlace_express_sqlserver_ddl.sql`: Script DDL utilizado para definir la estructura de la base de datos.

## Base de datos

* **Motor:** Microsoft SQL Server
* **Base de datos:** `enlace_express`
* **Esquema:** `dbo`
...
El script incluido corresponde a la estructura actual de la base de datos **EnlaceExpress** en Microsoft SQL Server.
