# EnlaceExpress - PostgreSQL

## Descripción

Esta carpeta contiene los archivos correspondientes a la implementación de la base de datos **EnlaceExpress** en PostgreSQL.

EnlaceExpress es un sistema orientado a la gestión de envíos y servicios de mensajería empresarial.

## Archivos

* `enlace_express_postgresql_ddl.sql`: Script DDL utilizado para definir la estructura de la base de datos.
...
El script incluido corresponde a la estructura actual de la base de datos **EnlaceExpress** en PostgreSQL.
